const LiquidButton = class LiquidButton {
  constructor(optionsParam) {
    ...
    this.color1 = options.color1 || '#a035e7';
    this.color2 = options.color2 || '#ffcc00';
    this.color3 = options.color3 || '#e60960';
    this.textColor = options.textColor || '#080808';
    this.layers = [{
      points: [],
      viscosity: 0.5,
      mouseForce: 100,
    ...
    this.fontName = options.fontName || 'sans-serif';
  ...
  draw() {
    ...
    this.context.font = this.fontWeight + ' ' + (this.height - this.padding * 2) + 'px ' + this.fontName;
...
$(document).ready(function () {
  ...
  function showPopup(e) {
    ...
    var cW = $(this).width();
    var cH = $(this).height();
    buttonArea = (e.offsetX >= m) && (e.offsetX <= cW - m);
    buttonArea = buttonArea && (e.offsetY >= m) && (e.offsetY <= cH - m);
    if (buttonArea) {
